...
<div class="container">
  <div class="section-top-border">
    <div class="row">
      ...
      <div class="col-6">
        <form action="/guru" method="get" class="sidebar-form float-right">
                    ...
                    <tr>
                      ...
                      <th>
                        <button type="button" class="m-0 p-0" data-toggle="modal" data-target="#kegiatan{{$guru->id}}">
                          <img title="{{$guru->nama_guru}}" style="max-width: 100px" class="img-fluid" src="{{ asset('/storage/guru/' . $guru->gambar_guru) }}" />
                        </button>
