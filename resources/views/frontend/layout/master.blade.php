...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="/frontend/vendors/popup/magnific-popup.css">
        <!-- main css -->
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script><a href="https://colorlib.com" target="_blank"> Rizal Ali Ridho</a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
        ...
        <script src="/frontend/vendors/popup/jquery.magnific-popup.min.js"></script>
