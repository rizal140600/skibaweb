                    ...
                    <tr>
                      ...
                      <th >
                        ...
                        <button type="button" class="m-0 p-0" data-toggle="modal" data-target="#jurusan{{$jurusan->id}}">
                          <img style="max-width: 100px" class="img-fluid" src="{{ asset('/storage/jurusan/' . $jurusan->jurusan_gambar) }}" />
                        </button>
                        ...
                        <div class="modal fade" id="jurusan{{$jurusan->id}}" tabindex="-1" role="dialog" aria-labelledby="jurusan{{$jurusan->id}}Label" aria-hidden="true">
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              <img class="img-fluid" src="{{ asset('/storage/jurusan/' . $jurusan->jurusan_gambar) }}" />
                      ...
                      <td>
                        <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#isi{{$jurusan->id}}">
